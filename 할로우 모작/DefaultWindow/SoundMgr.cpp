...
void CSoundMgr::PlaySound(TCHAR * pSoundKey, CHANNEL_TYPE eID, float fVolume)
{
...
void CSoundMgr::PlayLoop(TCHAR * pSoundKey, CHANNEL_TYPE eID, float fVolume)
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
...
void CSoundMgr::StopSound(CHANNEL_TYPE eID)
{
...
void CSoundMgr::SetChannelVolume(CHANNEL_TYPE eID, float fVolume)
{
	FMOD_Channel_SetVolume(m_pChannelArr[eID], fVolume);
